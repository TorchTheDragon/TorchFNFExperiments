...
HXDLIN( 574)		if (::hx::IsEq( child,this->content )) {
...
HXLINE( 628)				_hx_tmp = ::hx::IsEq( this->content->parent,::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE( 758)		 ::openfl::display::Loader _gthis = ::hx::ObjectPtr<OBJ_>(this);
