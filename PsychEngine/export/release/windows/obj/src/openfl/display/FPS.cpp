...
HXLINE(  90)			{
HXLINE(  90)				 ::openfl::display::FPS _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  90)				_g->set_text((_g->get_text() + ((HX_("\nMemory: ",11,56,a9,a3) + memoryMegas) + HX_(" MB",75,8b,18,00))));
            			}
...
HXLINE( 105)			{
HXLINE( 105)				 ::openfl::display::FPS _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 105)				_g1->set_text((_g1->get_text() + HX_("\n",0a,00,00,00)));
            			}
            		}
