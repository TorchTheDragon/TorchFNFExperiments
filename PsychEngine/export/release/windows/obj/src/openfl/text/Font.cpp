...
HXLINE( 291)					this->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(::openfl::utils::Assets_obj::getBytes(this->_hx___fontID)));
...
HXLINE( 124)		font->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
...
HXDLIN( 179)		return ::lime::text::Font_obj::loadFromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes))->then( ::Dynamic(new _hx_Closure_0()));
            	}
