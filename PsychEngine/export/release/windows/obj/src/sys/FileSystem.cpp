...
HX_LOCAL_STACK_FRAME(_hx_pos_7d210d079223995c_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/cpp/_std/sys/FileSystem.hx",31,0x45f6c240)
HX_LOCAL_STACK_FRAME(_hx_pos_7d210d079223995c_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/cpp/_std/sys/FileSystem.hx",38,0x45f6c240)
HX_LOCAL_STACK_FRAME(_hx_pos_7d210d079223995c_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/cpp/_std/sys/FileSystem.hx",75,0x45f6c240)
HX_LOCAL_STACK_FRAME(_hx_pos_7d210d079223995c_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/cpp/_std/sys/FileSystem.hx",78,0x45f6c240)
HX_LOCAL_STACK_FRAME(_hx_pos_7d210d079223995c_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/cpp/_std/sys/FileSystem.hx",93,0x45f6c240)
HX_LOCAL_STACK_FRAME(_hx_pos_7d210d079223995c_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/cpp/_std/sys/FileSystem.hx",101,0x45f6c240)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_7d210d079223995c_31_exists)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_7d210d079223995c_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_7d210d079223995c_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_7d210d079223995c_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_7d210d079223995c_93_deleteFile)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_7d210d079223995c_101_readDirectory)
