...
HXLINE( 598)		{
HXLINE( 598)			 ::flixel::math::FlxBasePoint _g = this->button->offset;
HXDLIN( 598)			_g->set_x((_g->x - ( (Float)((Width - this->button->frameWidth)) )));
            		}
HXLINE( 599)		this->button->set_x(this->offset->x);
HXLINE( 600)		{
HXLINE( 600)			 ::flixel::math::FlxBasePoint _g1 = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 600)			_g1->set_x((_g1->x + this->button->offset->x));
            		}
