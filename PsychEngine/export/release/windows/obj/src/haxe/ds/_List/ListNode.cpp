...
HX_DEFINE_STACK_FRAME(_hx_pos_8304c636385d23e5_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","C:\\ProgramData\\chocolatey\\lib\\haxe\\haxe_20201231082044_5e33a78aa\\std/haxe/ds/List.hx",266,0x045fb63b)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_8304c636385d23e5_266_new)
