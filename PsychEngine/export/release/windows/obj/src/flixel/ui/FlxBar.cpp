...
HXDLIN( 861)						{
HXLINE( 861)							 ::flixel::math::FlxBasePoint _g2 = this1;
HXDLIN( 861)							_g2->set_x((_g2->x - point->x));
            						}
HXDLIN( 861)						{
HXLINE( 861)							 ::flixel::math::FlxBasePoint _g3 = this1;
HXDLIN( 861)							_g3->set_y((_g3->y - y));
            						}
            					}
...
HXDLIN( 873)					{
HXLINE( 873)						 ::flixel::math::FlxBasePoint _g4 = this2;
HXDLIN( 873)						_g4->set_x((_g4->x + this->origin->x));
            					}
HXDLIN( 873)					{
HXLINE( 873)						 ::flixel::math::FlxBasePoint _g5 = this2;
HXDLIN( 873)						_g5->set_y((_g5->y + y1));
            					}
            				}
