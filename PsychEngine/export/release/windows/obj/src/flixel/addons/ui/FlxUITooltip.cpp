...
HXDLIN( 100)			_hx_tmp->set_x(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) )->x)) ));
HXLINE( 101)			 ::flixel::addons::ui::FlxUIText _hx_tmp1 = this->_titleText;
HXDLIN( 101)			_hx_tmp1->set_y(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) )->y)) ));
            		}
...
HXDLIN( 105)			_hx_tmp->set_x(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) )->x)) ));
HXLINE( 106)			 ::flixel::addons::ui::FlxUIText _hx_tmp1 = this->_bodyText;
HXDLIN( 106)			_hx_tmp1->set_y(( (Float)(::Std_obj::_hx_int(((this->_titleText->y + titleHeight) + ( ( ::flixel::math::FlxBasePoint)(this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) )->y))) ));
            		}
...
HXLINE( 702)			 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 702)			Style->__SetField(HX_("titleOffset",4b,63,cb,f6),this1,::hx::paccDynamic);
            		}
HXLINE( 704)		if (::hx::IsNull( Style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic) )) {
HXLINE( 706)			 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 706)			Style->__SetField(HX_("bodyOffset",d5,2b,5c,a7),this1,::hx::paccDynamic);
            		}
...
HXLINE( 776)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 777)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 777)			point->_inPool = false;
HXDLIN( 777)			p1 = point;
            		}
