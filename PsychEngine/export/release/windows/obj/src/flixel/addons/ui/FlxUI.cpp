...
HXDLIN(1970)		 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,this->_loadHeight(node,( (Float)(0) ),HX_("y",79,00,00,00),null()));
HXDLIN(1970)		 ::flixel::math::FlxBasePoint offset = this1;
...
HXLINE(2152)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE(2305)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(-1,-1);
...
HXDLIN(3165)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXDLIN(3169)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXLINE(3557)				 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,0,0);
HXDLIN(3557)				toleranceRes = this1;
            			}
...
HXLINE(3710)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(tab_x,tab_y);
...
HXLINE(3887)				 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,resize_ratio,defaultAxis);
HXDLIN(3887)				return this1;
            			}
            			else {
HXLINE(3892)				 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,::Std_obj::parseFloat(str),1);
HXDLIN(3892)				return this1;
            			}
            		}
            		else {
HXLINE(3898)			 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,::Std_obj::parseFloat(str),0);
HXDLIN(3898)			return this1;
            		}
...
HXLINE(4278)							{
HXLINE(4278)								 ::flixel::math::FlxBasePoint _g = sprite->offset;
HXDLIN(4278)								_g->set_x((_g->x - ( (Float)(text_x) )));
            							}
HXLINE(4279)							{
HXLINE(4279)								 ::flixel::math::FlxBasePoint _g1 = sprite->offset;
...
HXLINE(4286)				{
HXLINE(4286)					 ::flixel::math::FlxBasePoint _g = ( ( ::flixel::FlxSprite)(fbs->label) )->offset;
HXDLIN(4286)					_g->set_x((_g->x - ( (Float)(text_x) )));
            				}
HXLINE(4287)				{
HXLINE(4287)					 ::flixel::math::FlxBasePoint _g1 = ( ( ::flixel::FlxSprite)(fbs->label) )->offset;
HXDLIN(4287)					_g1->set_y((_g1->y - ( (Float)(text_y) )));
            				}
HXLINE(4288)				if (::hx::IsNotNull( toggleSprite )) {
HXLINE(4290)					{
HXLINE(4290)						 ::flixel::math::FlxBasePoint _g = toggleSprite->offset;
HXDLIN(4290)						_g->set_x((_g->x - ( (Float)(text_x) )));
            					}
HXLINE(4291)					{
HXLINE(4291)						 ::flixel::math::FlxBasePoint _g1 = toggleSprite->offset;
...
HXLINE(4299)			{
HXLINE(4299)				 ::flixel::math::FlxBasePoint _g = ( ( ::flixel::FlxSprite)(fbu->label) )->offset;
HXDLIN(4299)				_g->set_x((_g->x - ( (Float)(text_x) )));
            			}
HXLINE(4300)			{
HXLINE(4300)				 ::flixel::math::FlxBasePoint _g1 = ( ( ::flixel::FlxSprite)(fbu->label) )->offset;
