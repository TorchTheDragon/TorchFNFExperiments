...
HXDLIN( 322)				 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,::Std_obj::parseFloat(arr->__get(1)));
HXDLIN( 322)				pt = this1;
            			}
            		}
...
HXLINE( 652)			 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXDLIN( 652)			pt = this1;
            		}
...
HXLINE( 751)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(xx,yy);
...
HXDLIN(1930)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
