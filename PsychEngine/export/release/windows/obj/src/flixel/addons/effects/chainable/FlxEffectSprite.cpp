...
HXDLIN(  85)		 ::flixel::math::FlxBasePoint this1 = this->super::getScreenPosition(point,Camera);
HXDLIN(  85)		 ::flixel::math::FlxBasePoint point1 = this->_effectOffset;
HXDLIN(  85)		{
HXDLIN(  85)			Float y = point1->y;
HXDLIN(  85)			{
HXDLIN(  85)				 ::flixel::math::FlxBasePoint _g = this1;
HXDLIN(  85)				_g->set_x((_g->x + point1->x));
            			}
HXDLIN(  85)			{
HXDLIN(  85)				 ::flixel::math::FlxBasePoint _g1 = this1;
HXDLIN(  85)				_g1->set_y((_g1->y + y));
            			}
            		}
HXDLIN(  85)		if (point1->_weak) {
HXDLIN(  85)			point1->put();
            		}
...
HXLINE( 121)							 ::flixel::math::FlxBasePoint this1 = this->_effectOffset;
...
HXDLIN( 121)								{
HXLINE( 121)									 ::flixel::math::FlxBasePoint _g = this1;
HXDLIN( 121)									_g->set_x((_g->x + point->x));
            								}
HXDLIN( 121)								{
HXLINE( 121)									 ::flixel::math::FlxBasePoint _g1 = this1;
HXDLIN( 121)									_g1->set_y((_g1->y + y));
            								}
            							}
HXDLIN( 121)							if (point->_weak) {
HXLINE( 121)								point->put();
            							}
            						}
            					}
            				}
