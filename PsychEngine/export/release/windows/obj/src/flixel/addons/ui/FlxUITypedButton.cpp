...
HXLINE( 161)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
...
HXLINE( 201)			 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,other->_centerLabelOffset->x,other->_centerLabelOffset->y);
HXDLIN( 201)			this->_centerLabelOffset = this1;
            		}
...
HXDLIN( 960)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
