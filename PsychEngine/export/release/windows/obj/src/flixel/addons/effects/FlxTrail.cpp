...
HXLINE( 109)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 164)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 186)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 186)					point->_inPool = false;
HXDLIN( 186)					spriteScale = point;
            				}
HXLINE( 189)				{
HXLINE( 189)					Float y = this->target->scale->y;
HXDLIN( 189)					spriteScale->set_x(this->target->scale->x);
HXDLIN( 189)					spriteScale->set_y(y);
            				}
