...
HXLINE( 175)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
HXDLIN( 175)			point->_inPool = false;
HXDLIN( 175)			this->prevButtonOffset = point;
            		}
HXLINE( 177)		if (::hx::IsNull( this->nextButtonOffset )) {
HXLINE( 179)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
