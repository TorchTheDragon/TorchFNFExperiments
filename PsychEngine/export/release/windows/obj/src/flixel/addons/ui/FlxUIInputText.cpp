...
HX_DEFINE_STACK_FRAME(_hx_pos_3220fe253d6a28c5_11_new,"flixel.addons.ui.FlxUIInputText","new",0x1be658b4,"flixel.addons.ui.FlxUIInputText.new","flixel/addons/ui/FlxUIInputText.hx",11,0x43f86a3b)
HX_LOCAL_STACK_FRAME(_hx_pos_3220fe253d6a28c5_26_resize,"flixel.addons.ui.FlxUIInputText","resize",0x10b3be20,"flixel.addons.ui.FlxUIInputText.resize","flixel/addons/ui/FlxUIInputText.hx",26,0x43f86a3b)
HX_LOCAL_STACK_FRAME(_hx_pos_3220fe253d6a28c5_33_onChange,"flixel.addons.ui.FlxUIInputText","onChange",0x695a4f1b,"flixel.addons.ui.FlxUIInputText.onChange","flixel/addons/ui/FlxUIInputText.hx",33,0x43f86a3b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3220fe253d6a28c5_23_boot,"flixel.addons.ui.FlxUIInputText","boot",0x45c0455e,"flixel.addons.ui.FlxUIInputText.boot","flixel/addons/ui/FlxUIInputText.hx",23,0x43f86a3b)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUIInputText_obj::__construct( ::Dynamic X, ::Dynamic Y, ::Dynamic Width,::String Text, ::Dynamic size, ::Dynamic TextColor, ::Dynamic BackgroundColor, ::Dynamic EmbeddedFont){
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_11_new)
HXLINE(  15)		this->broadcastToFlxUI = true;
HXLINE(  11)		super::__construct(X,Y,Width,Text,size,TextColor,BackgroundColor,EmbeddedFont);
            	}
...
void FlxUIInputText_obj::resize(Float w,Float h){
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_26_resize)
HXLINE(  27)		this->set_width(w);
HXLINE(  28)		this->set_height(h);
HXLINE(  29)		this->calcFrame(null());
            	}
...
void FlxUIInputText_obj::onChange(::String action){
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_33_onChange)
HXLINE(  34)		this->super::onChange(action);
HXLINE(  35)		if (this->broadcastToFlxUI) {
HXLINE(  37)			::String _hx_switch_0 = action;
            			if (  (_hx_switch_0==HX_("backspace",3f,85,ea,ca)) ||  (_hx_switch_0==HX_("delete",2b,c0,d8,6a)) ){
HXLINE(  42)				::flixel::addons::ui::FlxUI_obj::event(HX_("delete_input_text",16,b7,28,af),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  43)				::flixel::addons::ui::FlxUI_obj::event(HX_("change_input_text",f1,11,47,68),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  41)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("copy",b5,bb,c4,41)) ){
HXLINE(  48)				::flixel::addons::ui::FlxUI_obj::event(HX_("copy_input_text",cc,b3,c9,5b),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXDLIN(  48)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("cut",82,85,4b,00)) ){
HXLINE(  53)				::flixel::addons::ui::FlxUI_obj::event(HX_("cut_input_text",1f,53,60,b2),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  54)				::flixel::addons::ui::FlxUI_obj::event(HX_("change_input_text",f1,11,47,68),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  52)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("enter",18,6d,86,70)) ){
HXLINE(  40)				::flixel::addons::ui::FlxUI_obj::event(HX_("enter_input_text",49,07,7b,5a),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXDLIN(  40)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("input",0a,c4,1d,be)) ){
HXLINE(  45)				::flixel::addons::ui::FlxUI_obj::event(HX_("input_input_text",97,11,0d,4c),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  46)				::flixel::addons::ui::FlxUI_obj::event(HX_("change_input_text",f1,11,47,68),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  44)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("paste",53,53,56,bd)) ){
HXLINE(  50)				::flixel::addons::ui::FlxUI_obj::event(HX_("paste_input_text",ee,24,a7,55),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  51)				::flixel::addons::ui::FlxUI_obj::event(HX_("change_input_text",f1,11,47,68),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
...
HXDLIN(  17)		CHANGE_EVENT = HX_("change_input_text",f1,11,47,68);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_18_boot)
HXDLIN(  18)		ENTER_EVENT = HX_("enter_input_text",49,07,7b,5a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_19_boot)
HXDLIN(  19)		DELETE_EVENT = HX_("delete_input_text",16,b7,28,af);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_20_boot)
HXDLIN(  20)		INPUT_EVENT = HX_("input_input_text",97,11,0d,4c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_21_boot)
HXDLIN(  21)		COPY_EVENT = HX_("copy_input_text",cc,b3,c9,5b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_22_boot)
HXDLIN(  22)		PASTE_EVENT = HX_("paste_input_text",ee,24,a7,55);
            	}
{
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_23_boot)
HXDLIN(  23)		CUT_EVENT = HX_("cut_input_text",1f,53,60,b2);
            	}
}
