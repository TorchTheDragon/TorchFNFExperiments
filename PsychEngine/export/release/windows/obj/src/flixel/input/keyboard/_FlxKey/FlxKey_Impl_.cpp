...
HX_LOCAL_STACK_FRAME(_hx_pos_a9115cea19c56d84_118_fromString,"flixel.input.keyboard._FlxKey.FlxKey_Impl_","fromString",0xcc26c669,"flixel.input.keyboard._FlxKey.FlxKey_Impl_.fromString","flixel/input/keyboard/FlxKey.hx",118,0x46a3c741)
HX_LOCAL_STACK_FRAME(_hx_pos_a9115cea19c56d84_126_toString,"flixel.input.keyboard._FlxKey.FlxKey_Impl_","toString",0xf3f689ba,"flixel.input.keyboard._FlxKey.FlxKey_Impl_.toString","flixel/input/keyboard/FlxKey.hx",126,0x46a3c741)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a9115cea19c56d84_114_boot,"flixel.input.keyboard._FlxKey.FlxKey_Impl_","boot",0xb4b21e40,"flixel.input.keyboard._FlxKey.FlxKey_Impl_.boot","flixel/input/keyboard/FlxKey.hx",114,0x46a3c741)
namespace flixel{
namespace input{
namespace keyboard{
namespace _FlxKey{
...
int FlxKey_Impl__obj::fromString(::String s){
            	HX_STACKFRAME(&_hx_pos_a9115cea19c56d84_118_fromString)
HXLINE( 119)		s = s.toUpperCase();
HXLINE( 120)		if (::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->exists(s)) {
HXLINE( 120)			return ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->get_int(s);
            		}
            		else {
HXLINE( 120)			return -1;
            		}
...
::String FlxKey_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_a9115cea19c56d84_126_toString)
HXDLIN( 126)		return ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::toStringMap->get_string(this1);
            	}
