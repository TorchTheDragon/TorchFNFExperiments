...
HXDLIN( 639)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXLINE( 747)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(xAxis,yAxis);
HXDLIN( 747)		point->_inPool = false;
HXDLIN( 747)		 ::flixel::math::FlxBasePoint vector = point;
