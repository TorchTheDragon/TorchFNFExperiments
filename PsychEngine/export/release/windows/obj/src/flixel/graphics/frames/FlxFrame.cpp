...
HXLINE( 105)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 105)		point->_inPool = false;
HXDLIN( 105)		this->sourceSize = point;
HXLINE( 106)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 303)			{
HXLINE( 303)				 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN( 303)				 ::openfl::geom::Point p = this->point2;
HXDLIN( 303)				if (::hx::IsNull( p )) {
HXLINE( 303)					p =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
            				}
HXDLIN( 303)				p->x = this1->x;
HXDLIN( 303)				p->y = this1->y;
            			}
...
HXDLIN( 306)			 ::flixel::math::FlxRect _this = this->frame;
...
HXDLIN( 306)			FlashRect->x = _this->x;
HXDLIN( 306)			FlashRect->y = _this->y;
HXDLIN( 306)			FlashRect->width = _this->width;
HXDLIN( 306)			FlashRect->height = _this->height;
...
HXDLIN( 312)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
HXDLIN( 312)			point1->_inPool = false;
HXDLIN( 312)			 ::flixel::math::FlxBasePoint point2 = point1;
HXDLIN( 312)			point2->_weak = true;
HXDLIN( 312)			 ::flixel::math::FlxBasePoint p1 = point2;
...
HXDLIN( 312)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y1);
HXDLIN( 312)			point3->_inPool = false;
HXDLIN( 312)			 ::flixel::math::FlxBasePoint point4 = point3;
HXDLIN( 312)			point4->_weak = true;
HXDLIN( 312)			 ::flixel::math::FlxBasePoint p2 = point4;
HXDLIN( 312)			{
HXLINE( 312)				Float x11 = (((p1->x * mat1->a) + (p1->y * mat1->c)) + mat1->tx);
HXDLIN( 312)				Float y11 = (((p1->x * mat1->b) + (p1->y * mat1->d)) + mat1->ty);
HXDLIN( 312)				{
HXLINE( 312)					p1->set_x(x11);
HXDLIN( 312)					p1->set_y(y11);
            				}
            			}
HXDLIN( 312)			{
HXLINE( 312)				Float x12 = (((p2->x * mat1->a) + (p2->y * mat1->c)) + mat1->tx);
HXDLIN( 312)				Float y12 = (((p2->x * mat1->b) + (p2->y * mat1->d)) + mat1->ty);
HXDLIN( 312)				{
HXLINE( 312)					p2->set_x(x12);
HXDLIN( 312)					p2->set_y(y12);
            				}
            			}
...
HXDLIN( 356)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
HXDLIN( 356)		point1->_inPool = false;
HXDLIN( 356)		 ::flixel::math::FlxBasePoint point2 = point1;
HXDLIN( 356)		point2->_weak = true;
HXDLIN( 356)		 ::flixel::math::FlxBasePoint p1 = point2;
...
HXDLIN( 356)		 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y1);
HXDLIN( 356)		point3->_inPool = false;
HXDLIN( 356)		 ::flixel::math::FlxBasePoint point4 = point3;
HXDLIN( 356)		point4->_weak = true;
HXDLIN( 356)		 ::flixel::math::FlxBasePoint p2 = point4;
HXDLIN( 356)		{
HXLINE( 356)			Float x11 = (((p1->x * mat->a) + (p1->y * mat->c)) + mat->tx);
HXDLIN( 356)			Float y11 = (((p1->x * mat->b) + (p1->y * mat->d)) + mat->ty);
HXDLIN( 356)			{
HXLINE( 356)				p1->set_x(x11);
HXDLIN( 356)				p1->set_y(y11);
            			}
            		}
HXDLIN( 356)		{
HXLINE( 356)			Float x12 = (((p2->x * mat->a) + (p2->y * mat->c)) + mat->tx);
HXDLIN( 356)			Float y12 = (((p2->x * mat->b) + (p2->y * mat->d)) + mat->ty);
HXDLIN( 356)			{
HXLINE( 356)				p2->set_x(x12);
HXDLIN( 356)				p2->set_y(y12);
            			}
            		}
...
HXDLIN( 412)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
HXDLIN( 412)		point->_inPool = false;
HXDLIN( 412)		 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN( 412)		point1->_weak = true;
HXDLIN( 412)		 ::flixel::math::FlxBasePoint p1 = point1;
...
HXDLIN( 413)		 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y1);
HXDLIN( 413)		point2->_inPool = false;
HXDLIN( 413)		 ::flixel::math::FlxBasePoint point3 = point2;
HXDLIN( 413)		point3->_weak = true;
HXDLIN( 413)		 ::flixel::math::FlxBasePoint p2 = point3;
HXLINE( 415)		{
HXLINE( 415)			Float x11 = (((p1->x * mat->a) + (p1->y * mat->c)) + mat->tx);
HXDLIN( 415)			Float y11 = (((p1->x * mat->b) + (p1->y * mat->d)) + mat->ty);
HXDLIN( 415)			{
HXLINE( 415)				p1->set_x(x11);
HXDLIN( 415)				p1->set_y(y11);
            			}
            		}
HXLINE( 416)		{
HXLINE( 416)			Float x12 = (((p2->x * mat->a) + (p2->y * mat->c)) + mat->tx);
HXDLIN( 416)			Float y12 = (((p2->x * mat->b) + (p2->y * mat->d)) + mat->ty);
HXDLIN( 416)			{
HXLINE( 416)				p2->set_x(x12);
HXDLIN( 416)				p2->set_y(y12);
            			}
            		}
...
HXLINE( 444)		{
HXLINE( 444)			 ::flixel::math::FlxBasePoint this1 = frameToFill->sourceSize;
HXDLIN( 444)			Float y = rect->height;
HXDLIN( 444)			this1->set_x(rect->width);
HXDLIN( 444)			this1->set_y(y);
            		}
HXLINE( 447)		if ((this->type == 2)) {
HXLINE( 449)			frameToFill->type = 2;
HXLINE( 450)			{
HXLINE( 450)				 ::flixel::math::FlxBasePoint this1 = frameToFill->offset;
HXDLIN( 450)				this1->set_x(( (Float)(0) ));
HXDLIN( 450)				this1->set_y(( (Float)(0) ));
            			}
...
HXLINE( 474)			{
HXLINE( 474)				 ::flixel::math::FlxBasePoint this1 = frameToFill->offset;
HXDLIN( 474)				this1->set_x(( (Float)(0) ));
HXDLIN( 474)				this1->set_y(( (Float)(0) ));
            			}
            		}
            		else {
HXLINE( 478)			frameToFill->type = 0;
HXLINE( 479)			{
HXLINE( 479)				 ::flixel::math::FlxBasePoint this1 = frameToFill->offset;
HXDLIN( 479)				Float y = frameRect->y;
HXDLIN( 479)				this1->set_x(frameRect->x);
HXDLIN( 479)				this1->set_y(y);
HXDLIN( 479)				 ::flixel::math::FlxBasePoint this2 = this1;
HXDLIN( 479)				Float y1 = rect->y;
HXDLIN( 479)				{
HXLINE( 479)					 ::flixel::math::FlxBasePoint _g = this2;
HXDLIN( 479)					_g->set_x((_g->x - rect->x));
            				}
HXDLIN( 479)				{
HXLINE( 479)					 ::flixel::math::FlxBasePoint _g1 = this2;
HXDLIN( 479)					_g1->set_y((_g1->y - y1));
            				}
HXDLIN( 479)				 ::flixel::math::FlxBasePoint this3 = this2;
HXDLIN( 479)				 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN( 479)				{
HXLINE( 479)					Float y2 = point->y;
HXDLIN( 479)					{
HXLINE( 479)						 ::flixel::math::FlxBasePoint _g2 = this3;
HXDLIN( 479)						_g2->set_x((_g2->x + point->x));
            					}
HXDLIN( 479)					{
HXLINE( 479)						 ::flixel::math::FlxBasePoint _g3 = this3;
HXDLIN( 479)						_g3->set_y((_g3->y + y2));
            					}
            				}
HXDLIN( 479)				if (point->_weak) {
HXLINE( 479)					point->put();
            				}
            			}
HXLINE( 481)			Float x = frameRect->x;
HXDLIN( 481)			Float y3 = frameRect->y;
HXDLIN( 481)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y3);
HXDLIN( 481)			point1->_inPool = false;
HXDLIN( 481)			 ::flixel::math::FlxBasePoint point2 = point1;
HXDLIN( 481)			point2->_weak = true;
HXDLIN( 481)			 ::flixel::math::FlxBasePoint p1 = point2;
HXLINE( 482)			Float x1 = (frameRect->x + frameRect->width);
HXDLIN( 482)			Float y4 = (frameRect->y + frameRect->height);
HXDLIN( 482)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y4);
HXDLIN( 482)			point3->_inPool = false;
HXDLIN( 482)			 ::flixel::math::FlxBasePoint point4 = point3;
HXDLIN( 482)			point4->_weak = true;
HXDLIN( 482)			 ::flixel::math::FlxBasePoint p2 = point4;
...
HXDLIN( 499)					{
HXLINE( 499)						p1->set_x(x1);
HXDLIN( 499)						p1->set_y(y1);
            					}
            				}
HXLINE( 500)				{
...
HXDLIN( 500)					{
HXLINE( 500)						p2->set_x(x11);
HXDLIN( 500)						p2->set_y(y11);
            					}
            				}
            			}
HXLINE( 503)			{
...
HXLINE( 549)		{
HXLINE( 549)			 ::flixel::math::FlxBasePoint this1 = clippedFrame->sourceSize;
HXDLIN( 549)			 ::flixel::math::FlxBasePoint p = this->sourceSize;
HXDLIN( 549)			{
HXLINE( 549)				Float y = p->y;
HXDLIN( 549)				this1->set_x(p->x);
HXDLIN( 549)				this1->set_y(y);
            			}
HXDLIN( 549)			if (p->_weak) {
HXLINE( 549)				p->put();
            			}
            		}
...
HXLINE( 556)			{
HXLINE( 556)				 ::flixel::math::FlxBasePoint this1 = clippedFrame->offset;
HXDLIN( 556)				this1->set_x(( (Float)(0) ));
HXDLIN( 556)				this1->set_y(( (Float)(0) ));
            			}
HXLINE( 557)			return clippedFrame;
            		}
HXLINE( 560)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 560)		_this->x = ( (Float)(0) );
HXDLIN( 560)		_this->y = ( (Float)(0) );
HXDLIN( 560)		_this->width = ( (Float)(0) );
HXDLIN( 560)		_this->height = ( (Float)(0) );
HXDLIN( 560)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 560)		rect->_inPool = false;
HXDLIN( 560)		 ::flixel::math::FlxRect _this1 = rect;
HXDLIN( 560)		_this1->width = this->frame->width;
HXDLIN( 560)		_this1->height = this->frame->height;
HXDLIN( 560)		 ::flixel::math::FlxRect clippedRect = _this1;
...
HXLINE( 576)			{
HXLINE( 576)				 ::flixel::math::FlxBasePoint this1 = clippedFrame->offset;
HXDLIN( 576)				this1->set_x(( (Float)(0) ));
HXDLIN( 576)				this1->set_y(( (Float)(0) ));
            			}
            		}
            		else {
HXLINE( 580)			clippedFrame->type = 0;
HXLINE( 581)			{
HXLINE( 581)				 ::flixel::math::FlxBasePoint this1 = clippedFrame->offset;
HXDLIN( 581)				Float y = frameRect->y;
HXDLIN( 581)				this1->set_x(frameRect->x);
HXDLIN( 581)				this1->set_y(y);
HXDLIN( 581)				 ::flixel::math::FlxBasePoint this2 = this1;
HXDLIN( 581)				 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN( 581)				{
HXLINE( 581)					Float y1 = point->y;
HXDLIN( 581)					{
HXLINE( 581)						 ::flixel::math::FlxBasePoint _g = this2;
HXDLIN( 581)						_g->set_x((_g->x + point->x));
            					}
HXDLIN( 581)					{
HXLINE( 581)						 ::flixel::math::FlxBasePoint _g1 = this2;
HXDLIN( 581)						_g1->set_y((_g1->y + y1));
            					}
            				}
HXDLIN( 581)				if (point->_weak) {
HXLINE( 581)					point->put();
            				}
            			}
HXLINE( 583)			Float x = frameRect->x;
HXDLIN( 583)			Float y2 = frameRect->y;
HXDLIN( 583)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y2);
HXDLIN( 583)			point1->_inPool = false;
HXDLIN( 583)			 ::flixel::math::FlxBasePoint point2 = point1;
HXDLIN( 583)			point2->_weak = true;
HXDLIN( 583)			 ::flixel::math::FlxBasePoint p1 = point2;
HXLINE( 584)			Float x1 = (frameRect->x + frameRect->width);
HXDLIN( 584)			Float y3 = (frameRect->y + frameRect->height);
HXDLIN( 584)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y3);
HXDLIN( 584)			point3->_inPool = false;
HXDLIN( 584)			 ::flixel::math::FlxBasePoint point4 = point3;
HXDLIN( 584)			point4->_weak = true;
HXDLIN( 584)			 ::flixel::math::FlxBasePoint p2 = point4;
...
HXDLIN( 601)					{
HXLINE( 601)						p1->set_x(x1);
HXDLIN( 601)						p1->set_y(y1);
            					}
            				}
HXLINE( 602)				{
...
HXDLIN( 602)					{
HXLINE( 602)						p2->set_x(x11);
HXDLIN( 602)						p2->set_y(y11);
            					}
            				}
            			}
HXLINE( 605)			{
...
HXLINE( 634)		{
HXLINE( 634)			 ::flixel::math::FlxBasePoint this1 = clone->offset;
HXDLIN( 634)			 ::flixel::math::FlxBasePoint p = this->offset;
HXDLIN( 634)			{
HXLINE( 634)				Float y = p->y;
HXDLIN( 634)				this1->set_x(p->x);
HXDLIN( 634)				this1->set_y(y);
            			}
HXDLIN( 634)			if (p->_weak) {
HXLINE( 634)				p->put();
            			}
            		}
...
HXLINE( 637)		{
HXLINE( 637)			 ::flixel::math::FlxBasePoint this2 = clone->sourceSize;
HXDLIN( 637)			 ::flixel::math::FlxBasePoint p1 = this->sourceSize;
HXDLIN( 637)			{
HXLINE( 637)				Float y1 = p1->y;
HXDLIN( 637)				this2->set_x(p1->x);
HXDLIN( 637)				this2->set_y(y1);
            			}
HXDLIN( 637)			if (p1->_weak) {
HXLINE( 637)				p1->put();
            			}
            		}
HXLINE( 638)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 638)		_this->x = ( (Float)(0) );
HXDLIN( 638)		_this->y = ( (Float)(0) );
HXDLIN( 638)		_this->width = ( (Float)(0) );
HXDLIN( 638)		_this->height = ( (Float)(0) );
HXDLIN( 638)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 638)		rect->_inPool = false;
HXDLIN( 638)		 ::flixel::math::FlxRect _this1 = rect;
HXDLIN( 638)		 ::flixel::math::FlxRect Rect = this->frame;
HXDLIN( 638)		_this1->x = Rect->x;
HXDLIN( 638)		_this1->y = Rect->y;
HXDLIN( 638)		_this1->width = Rect->width;
HXDLIN( 638)		_this1->height = Rect->height;
...
HXDLIN( 638)		clone->set_frame(_this1);
...
HXLINE( 649)		this->sourceSize = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->sourceSize)) );
HXLINE( 650)		this->offset = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->offset)) );
