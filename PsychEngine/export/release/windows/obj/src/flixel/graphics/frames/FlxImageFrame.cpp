...
HXDLIN( 237)			{
HXLINE( 237)				 ::flixel::math::FlxBasePoint _g = this1;
HXDLIN( 237)				_g->set_x((_g->x + point2->x));
            			}
HXDLIN( 237)			{
HXLINE( 237)				 ::flixel::math::FlxBasePoint _g1 = this1;
HXDLIN( 237)				_g1->set_y((_g1->y + y));
            			}
            		}
...
HXDLIN( 237)			{
HXLINE( 237)				 ::flixel::math::FlxBasePoint _g2 = this2;
HXDLIN( 237)				_g2->set_x((_g2->x + border->x));
            			}
HXDLIN( 237)			{
HXLINE( 237)				 ::flixel::math::FlxBasePoint _g3 = this2;
HXDLIN( 237)				_g3->set_y((_g3->y + y1));
            			}
            		}
