...
HXLINE( 506)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 517)			{
HXLINE( 517)				 ::flixel::math::FlxBasePoint _g = this1;
HXDLIN( 517)				_g->set_x((_g->x + point1->x));
            			}
HXDLIN( 517)			{
HXLINE( 517)				 ::flixel::math::FlxBasePoint _g1 = this1;
HXDLIN( 517)				_g1->set_y((_g1->y + y));
            			}
            		}
...
HXDLIN( 517)			{
HXLINE( 517)				 ::flixel::math::FlxBasePoint _g2 = this2;
HXDLIN( 517)				_g2->set_x((_g2->x + border->x));
            			}
HXDLIN( 517)			{
HXLINE( 517)				 ::flixel::math::FlxBasePoint _g3 = this2;
HXDLIN( 517)				_g3->set_y((_g3->y + y1));
            			}
            		}
...
HXDLIN( 518)		{
HXLINE( 518)			 ::flixel::math::FlxBasePoint _g4 = this4;
HXDLIN( 518)			_g4->set_x((_g4->x - (( (Float)(2) ) * border->x)));
            		}
HXDLIN( 518)		{
HXLINE( 518)			 ::flixel::math::FlxBasePoint _g5 = this4;
HXDLIN( 518)			_g5->set_y((_g5->y - y3));
            		}
...
HXLINE( 532)		{
HXLINE( 532)			int _g6 = 0;
HXDLIN( 532)			::Array< ::Dynamic> _g7 = this->frames;
HXDLIN( 532)			while((_g6 < _g7->length)){
HXLINE( 532)				 ::flixel::graphics::frames::FlxFrame frame = _g7->__get(_g6).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 532)				_g6 = (_g6 + 1);
...
HXDLIN(  94)			{
HXLINE(  94)				 ::flixel::math::FlxBasePoint _g = this1;
HXDLIN(  94)				_g->set_x((_g->x + tileSize->x));
            			}
HXDLIN(  94)			{
HXLINE(  94)				 ::flixel::math::FlxBasePoint _g1 = this1;
HXDLIN(  94)				_g1->set_y((_g1->y + y));
            			}
            		}
...
HXDLIN(  94)		{
HXLINE(  94)			 ::flixel::math::FlxBasePoint _g2 = this2;
HXDLIN(  94)			_g2->set_x((_g2->x + (2 * borderX)));
            		}
HXDLIN(  94)		{
HXLINE(  94)			 ::flixel::math::FlxBasePoint _g3 = this2;
HXDLIN(  94)			_g3->set_y((_g3->y + (2 * borderY)));
            		}
...
HXLINE( 201)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 202)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
...
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(tileWidth,tileHeight);
HXDLIN( 443)						point->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
