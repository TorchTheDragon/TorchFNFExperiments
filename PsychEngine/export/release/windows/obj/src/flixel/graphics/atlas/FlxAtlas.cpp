...
HXDLIN( 645)			{
HXLINE( 645)				 ::flixel::math::FlxBasePoint _g = tileSize;
HXDLIN( 645)				_g->set_x((_g->x + (( (Float)(2) ) * tileBorder->x)));
            			}
HXDLIN( 645)			{
HXLINE( 645)				 ::flixel::math::FlxBasePoint _g1 = tileSize;
...
HXDLIN( 683)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y1);
HXDLIN( 683)				point->_inPool = false;
HXLINE( 682)				sourceSize = point;
            			}
HXLINE( 684)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
