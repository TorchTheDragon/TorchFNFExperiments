...
void FlxDrawTrianglesItem_obj::addTriangles( ::openfl::_Vector::FloatVector vertices, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector uvtData, ::openfl::_Vector::IntVector colors, ::flixel::math::FlxBasePoint position, ::flixel::math::FlxRect cameraBounds){
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_94_addTriangles)
HXLINE(  95)		if (::hx::IsNull( position )) {
HXLINE(  96)			 ::flixel::math::FlxBasePoint this1 = ::flixel::graphics::tile::FlxDrawTrianglesItem_obj::point;
HXDLIN(  96)			this1->set_x(( (Float)(0) ));
HXDLIN(  96)			this1->set_y(( (Float)(0) ));
HXDLIN(  96)			position = this1;
            		}
...
HXLINE( 203)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 203)		point->_inPool = false;
HXDLIN( 203)		 ::flixel::math::FlxBasePoint point1 = point;
HXLINE( 204)		{
...
HXDLIN( 204)			{
HXLINE( 204)				point1->set_x(x1);
HXDLIN( 204)				point1->set_y(y1);
            			}
            		}
...
HXLINE( 212)		{
HXLINE( 212)			point1->set_x(frame->frame->width);
HXDLIN( 212)			point1->set_y(( (Float)(0) ));
            		}
HXLINE( 213)		{
...
HXDLIN( 213)			{
HXLINE( 213)				point1->set_x(x11);
HXDLIN( 213)				point1->set_y(y11);
            			}
            		}
...
HXLINE( 221)		{
HXLINE( 221)			Float y = frame->frame->height;
HXDLIN( 221)			point1->set_x(frame->frame->width);
HXDLIN( 221)			point1->set_y(y);
            		}
HXLINE( 222)		{
...
HXDLIN( 222)			{
HXLINE( 222)				point1->set_x(x12);
HXDLIN( 222)				point1->set_y(y12);
            			}
            		}
...
HXLINE( 230)		{
HXLINE( 230)			Float y2 = frame->frame->height;
HXDLIN( 230)			point1->set_x(( (Float)(0) ));
HXDLIN( 230)			point1->set_y(y2);
            		}
HXLINE( 231)		{
...
HXDLIN( 231)			{
HXLINE( 231)				point1->set_x(x13);
HXDLIN( 231)				point1->set_y(y13);
            			}
            		}
...
HXDLIN(  21)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN(  21)			return point;
            	...
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_21_boot)
HXDLIN(  21)		point = ( ( ::flixel::math::FlxBasePoint)( ::Dynamic(new _hx_Closure_0())()) );
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
