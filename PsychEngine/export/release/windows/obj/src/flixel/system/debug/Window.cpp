...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_301_update,"flixel.system.debug.Window","update",0xcd50591f,"flixel.system.debug.Window.update","flixel/system/debug/Window.hx",301,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_309_init,"flixel.system.debug.Window","init",0x33a1fca6,"flixel.system.debug.Window.init","flixel/system/debug/Window.hx",309,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_327_onMouseMove,"flixel.system.debug.Window","onMouseMove",0xdd6abbe1,"flixel.system.debug.Window.onMouseMove","flixel/system/debug/Window.hx",327,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_367_onMouseDown,"flixel.system.debug.Window","onMouseDown",0xd777d132,"flixel.system.debug.Window.onMouseDown","flixel/system/debug/Window.hx",367,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_389_onMouseUp,"flixel.system.debug.Window","onMouseUp",0x62a36b2b,"flixel.system.debug.Window.onMouseUp","flixel/system/debug/Window.hx",389,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_399_bound,"flixel.system.debug.Window","bound",0xf2ff51e8,"flixel.system.debug.Window.bound","flixel/system/debug/Window.hx",399,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_410_updateSize,"flixel.system.debug.Window","updateSize",0x6f89a180,"flixel.system.debug.Window.updateSize","flixel/system/debug/Window.hx",410,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_434_close,"flixel.system.debug.Window","close",0x8465b962,"flixel.system.debug.Window.close","flixel/system/debug/Window.hx",434,0xb8dfd4e5)
...
HXLINE( 264)				::String _g1 = _g->_hx_getString(1);
HXDLIN( 264)				::String _g2 = _g->_hx_getString(0);
...
HXLINE( 267)			::flixel::FlxG_obj::save->flush(null());
            		}
...
HXLINE( 289)		 ::flixel::util::FlxSaveStatus _g = ::flixel::FlxG_obj::save->status;
HXDLIN( 289)		bool _hx_tmp;
HXDLIN( 289)		if ((_g->_hx_getIndex() == 1)) {
HXLINE( 289)			::String _g1 = _g->_hx_getString(1);
...
HXLINE( 292)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("windowSettings",f3,3c,19,85),::hx::paccDynamic) )) {
HXLINE( 294)			int maxWindows = 10;
HXLINE( 295)			::cpp::VirtualArray _g = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 295)			{
HXLINE( 295)				int _g1 = 0;
HXDLIN( 295)				int _g2 = maxWindows;
HXDLIN( 295)				while((_g1 < _g2)){
HXLINE( 295)					_g1 = (_g1 + 1);
HXDLIN( 295)					int _ = (_g1 - 1);
HXDLIN( 295)					_g->push(true);
            				}
            			}
HXDLIN( 295)			::flixel::FlxG_obj::save->data->__SetField(HX_("windowSettings",f3,3c,19,85),_g,::hx::paccDynamic);
HXLINE( 296)			::flixel::FlxG_obj::save->flush(null());
            		}
HXLINE( 298)		this->set_visible(( (bool)( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("windowSettings",f3,3c,19,85),::hx::paccDynamic))->__GetItem(this->_id)) ));
            	}
...
void Window_obj::update(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_301_update)
            	}
...
void Window_obj::init( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_309_init)
HXLINE( 310)		if (::hx::IsNull( this->stage )) {
HXLINE( 312)			return;
            		}
HXLINE( 314)		this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->init_dyn(),null());
HXLINE( 316)		this->stage->addEventListener(HX_("mouseMove",d6,9b,b5,f4),this->onMouseMove_dyn(),null(),null(),null());
HXLINE( 317)		this->stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->onMouseUp_dyn(),null(),null(),null());
HXLINE( 320)		this->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->onMouseDown_dyn(),null(),null(),null());
            	}
...
void Window_obj::onMouseMove( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_327_onMouseMove)
HXLINE( 329)		Float mouseX;
HXDLIN( 329)		if ((this->get_mouseX() < 0)) {
HXLINE( 329)			mouseX = ( (Float)(0) );
            		}
            		else {
HXLINE( 329)			mouseX = this->get_mouseX();
            		}
HXLINE( 330)		Float mouseY;
HXDLIN( 330)		if ((this->get_mouseY() < 0)) {
HXLINE( 330)			mouseY = ( (Float)(0) );
            		}
            		else {
HXLINE( 330)			mouseY = this->get_mouseY();
            		}
HXLINE( 332)		if (!(this->parent->get_visible())) {
HXLINE( 334)			this->_overHandle = (this->_overHeader = false);
HXLINE( 335)			return;
            		}
HXLINE( 338)		if (this->_dragging) {
HXLINE( 340)			this->_overHeader = true;
HXLINE( 341)			Float _hx_tmp = this->parent->get_mouseX();
HXDLIN( 341)			Float _hx_tmp1 = (_hx_tmp - this->_drag->x);
HXDLIN( 341)			Float _hx_tmp2 = this->parent->get_mouseY();
HXDLIN( 341)			this->reposition(_hx_tmp1,(_hx_tmp2 - this->_drag->y));
            		}
            		else {
HXLINE( 343)			if (this->_resizing) {
HXLINE( 345)				this->_overHandle = true;
HXLINE( 346)				this->resize((mouseX - this->_drag->x),(mouseY - this->_drag->y));
            			}
            			else {
HXLINE( 348)				bool _hx_tmp;
HXDLIN( 348)				bool _hx_tmp1;
HXDLIN( 348)				bool _hx_tmp2;
HXDLIN( 348)				if ((mouseX >= 0)) {
HXLINE( 348)					_hx_tmp2 = (mouseX <= this->_width);
            				}
            				else {
HXLINE( 348)					_hx_tmp2 = false;
            				}
HXDLIN( 348)				if (_hx_tmp2) {
HXLINE( 348)					_hx_tmp1 = (mouseY >= 0);
            				}
            				else {
HXLINE( 348)					_hx_tmp1 = false;
            				}
HXDLIN( 348)				if (_hx_tmp1) {
HXLINE( 348)					_hx_tmp = (mouseY <= this->_height);
            				}
            				else {
...
HXDLIN( 350)					if ((mouseX <= this->_header->get_width())) {
HXLINE( 350)						_hx_tmp = (mouseY <= this->_header->get_height());
            					}
            					else {
HXLINE( 350)						_hx_tmp = false;
            					}
HXDLIN( 350)					this->_overHeader = _hx_tmp;
HXLINE( 351)					if (this->_resizable) {
HXLINE( 353)						bool _hx_tmp;
HXDLIN( 353)						int _hx_tmp1 = this->_width;
HXDLIN( 353)						if ((mouseX >= (( (Float)(_hx_tmp1) ) - this->_handle->get_width()))) {
HXLINE( 353)							int _hx_tmp1 = this->_height;
HXDLIN( 353)							_hx_tmp = (mouseY >= (( (Float)(_hx_tmp1) ) - this->_handle->get_height()));
            						}
            						else {
HXLINE( 353)							_hx_tmp = false;
            						}
HXDLIN( 353)						this->_overHandle = _hx_tmp;
            					}
            				}
            				else {
HXLINE( 358)					this->_overHandle = (this->_overHeader = false);
            				}
            			}
            		}
            	}
...
void Window_obj::onMouseDown( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_367_onMouseDown)
HXDLIN( 367)		if (this->_overHeader) {
HXLINE( 369)			if (this->_alwaysOnTop) {
HXLINE( 370)				this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE( 371)			this->_dragging = true;
HXLINE( 372)			this->_drag->x = this->get_mouseX();
HXLINE( 373)			this->_drag->y = this->get_mouseY();
            		}
            		else {
HXLINE( 375)			if (this->_overHandle) {
HXLINE( 377)				if (this->_alwaysOnTop) {
HXLINE( 378)					this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            				}
HXLINE( 379)				this->_resizing = true;
HXLINE( 380)				int _hx_tmp = this->_width;
HXDLIN( 380)				Float _hx_tmp1 = this->get_mouseX();
HXDLIN( 380)				this->_drag->x = (( (Float)(_hx_tmp) ) - _hx_tmp1);
HXLINE( 381)				int _hx_tmp2 = this->_height;
HXDLIN( 381)				Float _hx_tmp3 = this->get_mouseY();
HXDLIN( 381)				this->_drag->y = (( (Float)(_hx_tmp2) ) - _hx_tmp3);
            			}
            		}
            	}
...
void Window_obj::onMouseUp( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_389_onMouseUp)
HXLINE( 390)		this->_dragging = false;
HXLINE( 391)		this->_resizing = false;
            	}
...
void Window_obj::bound(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_399_bound)
HXDLIN( 399)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 401)			Float Value = this->get_x();
HXDLIN( 401)			 ::Dynamic Min = this->_bounds->get_left();
HXDLIN( 401)			Float Max = this->_bounds->get_right();
HXDLIN( 401)			 ::Dynamic Max1 = (Max - ( (Float)(this->_width) ));
HXDLIN( 401)			Float lowerBound;
HXDLIN( 401)			bool lowerBound1;
HXDLIN( 401)			if (::hx::IsNotNull( Min )) {
HXLINE( 401)				lowerBound1 = ::hx::IsLess( Value,Min );
            			}
            			else {
HXLINE( 401)				lowerBound1 = false;
            			}
HXDLIN( 401)			if (lowerBound1) {
HXLINE( 401)				lowerBound = ( (Float)(Min) );
            			}
            			else {
HXLINE( 401)				lowerBound = Value;
            			}
HXDLIN( 401)			Float _hx_tmp;
HXDLIN( 401)			bool _hx_tmp1;
HXDLIN( 401)			if (::hx::IsNotNull( Max1 )) {
HXLINE( 401)				_hx_tmp1 = ::hx::IsGreater( lowerBound,Max1 );
            			}
            			else {
HXLINE( 401)				_hx_tmp1 = false;
            			}
HXDLIN( 401)			if (_hx_tmp1) {
HXLINE( 401)				_hx_tmp = ( (Float)(Max1) );
            			}
            			else {
HXLINE( 401)				_hx_tmp = lowerBound;
            			}
HXDLIN( 401)			this->set_x(_hx_tmp);
HXLINE( 402)			Float Value1 = this->get_y();
HXDLIN( 402)			 ::Dynamic Min1 = this->_bounds->get_top();
HXDLIN( 402)			Float Max2 = this->_bounds->get_bottom();
HXDLIN( 402)			 ::Dynamic Max3 = (Max2 - ( (Float)(this->_height) ));
HXDLIN( 402)			Float lowerBound2;
HXDLIN( 402)			bool lowerBound3;
HXDLIN( 402)			if (::hx::IsNotNull( Min1 )) {
HXLINE( 402)				lowerBound3 = ::hx::IsLess( Value1,Min1 );
            			}
            			else {
HXLINE( 402)				lowerBound3 = false;
            			}
HXDLIN( 402)			if (lowerBound3) {
HXLINE( 402)				lowerBound2 = ( (Float)(Min1) );
            			}
            			else {
HXLINE( 402)				lowerBound2 = Value1;
            			}
HXDLIN( 402)			Float _hx_tmp2;
HXDLIN( 402)			bool _hx_tmp3;
HXDLIN( 402)			if (::hx::IsNotNull( Max3 )) {
HXLINE( 402)				_hx_tmp3 = ::hx::IsGreater( lowerBound2,Max3 );
            			}
            			else {
HXLINE( 402)				_hx_tmp3 = false;
            			}
HXDLIN( 402)			if (_hx_tmp3) {
HXLINE( 402)				_hx_tmp2 = ( (Float)(Max3) );
            			}
            			else {
HXLINE( 402)				_hx_tmp2 = lowerBound2;
            			}
HXDLIN( 402)			this->set_y(_hx_tmp2);
            		}
            	}
...
void Window_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_410_updateSize)
HXLINE( 411)		Float Value = ( (Float)(this->_width) );
HXDLIN( 411)		 ::Dynamic Min = this->minSize->x;
HXDLIN( 411)		 ::Dynamic Max = this->maxSize->x;
...
HXDLIN( 411)		if (::hx::IsNotNull( Max )) {
HXLINE( 411)			_hx_tmp1 = ::hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 411)			_hx_tmp1 = false;
            		}
HXDLIN( 411)		if (_hx_tmp1) {
HXLINE( 411)			_hx_tmp = ( (Float)(Max) );
            		}
            		else {
HXLINE( 411)			_hx_tmp = lowerBound;
            		}
HXDLIN( 411)		this->_width = ::Std_obj::_hx_int(_hx_tmp);
HXLINE( 412)		Float Value1 = ( (Float)(this->_height) );
HXDLIN( 412)		 ::Dynamic Min1 = this->minSize->y;
HXDLIN( 412)		 ::Dynamic Max1 = this->maxSize->y;
...
HXLINE( 412)			_hx_tmp3 = ::hx::IsGreater( lowerBound2,Max1 );
            		}
            		else {
HXLINE( 412)			_hx_tmp3 = false;
            		}
HXDLIN( 412)		if (_hx_tmp3) {
HXLINE( 412)			_hx_tmp2 = ( (Float)(Max1) );
            		}
            		else {
HXLINE( 412)			_hx_tmp2 = lowerBound2;
            		}
HXDLIN( 412)		this->_height = ::Std_obj::_hx_int(_hx_tmp2);
HXLINE( 414)		this->_header->set_scaleX(( (Float)(this->_width) ));
HXLINE( 415)		this->_background->set_scaleX(( (Float)(this->_width) ));
HXLINE( 416)		 ::openfl::display::Bitmap _hx_tmp4 = this->_background;
HXDLIN( 416)		int _hx_tmp5 = this->_height;
HXDLIN( 416)		_hx_tmp4->set_scaleY((( (Float)(_hx_tmp5) ) - this->_header->get_height()));
HXLINE( 417)		this->_shadow->set_scaleX(( (Float)(this->_width) ));
HXLINE( 418)		this->_shadow->set_y(( (Float)(this->_height) ));
HXLINE( 419)		this->_title->set_width(( (Float)((this->_width - 4)) ));
HXLINE( 420)		if (this->_resizable) {
HXLINE( 422)			 ::openfl::display::Bitmap _hx_tmp = this->_handle;
HXDLIN( 422)			int _hx_tmp1 = this->_width;
HXDLIN( 422)			_hx_tmp->set_x((( (Float)(_hx_tmp1) ) - this->_handle->get_width()));
HXLINE( 423)			 ::openfl::display::Bitmap _hx_tmp2 = this->_handle;
HXDLIN( 423)			int _hx_tmp3 = this->_height;
HXDLIN( 423)			_hx_tmp2->set_y((( (Float)(_hx_tmp3) ) - this->_handle->get_height()));
            		}
HXLINE( 425)		if (::hx::IsNotNull( this->_closeButton )) {
HXLINE( 427)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_closeButton;
HXDLIN( 427)			int _hx_tmp1 = this->_width;
HXDLIN( 427)			_hx_tmp->set_x(((( (Float)(_hx_tmp1) ) - this->_closeButton->get_width()) - ( (Float)(3) )));
HXLINE( 428)			this->_closeButton->set_y(( (Float)(3) ));
            		}
            	}
...
void Window_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_434_close)
HXDLIN( 434)		this->destroy();
            	}
