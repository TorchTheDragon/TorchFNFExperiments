...
HX_LOCAL_STACK_FRAME(_hx_pos_b1aa19ce59d84264_115_update,"flixel.system.ui.FlxSoundTray","update",0x9cbad657,"flixel.system.ui.FlxSoundTray.update","flixel/system/ui/FlxSoundTray.hx",115,0x04618f9d)
HX_LOCAL_STACK_FRAME(_hx_pos_b1aa19ce59d84264_145_show,"flixel.system.ui.FlxSoundTray","show",0xb92bd5cb,"flixel.system.ui.FlxSoundTray.show","flixel/system/ui/FlxSoundTray.hx",145,0x04618f9d)
HX_LOCAL_STACK_FRAME(_hx_pos_b1aa19ce59d84264_178_screenCenter,"flixel.system.ui.FlxSoundTray","screenCenter",0x0f14ad2f,"flixel.system.ui.FlxSoundTray.screenCenter","flixel/system/ui/FlxSoundTray.hx",178,0x04618f9d)
namespace flixel{
...
HXLINE(  53)		this->silent = false;
HXLINE(  50)		this->volumeDownSound = HX_("flixel/sounds/beep",e6,b5,a9,33);
HXLINE(  47)		this->volumeUpSound = HX_("flixel/sounds/beep",e6,b5,a9,33);
HXLINE(  44)		this->_defaultScale = ((Float)2.0);
HXLINE(  42)		this->_width = 80;
HXLINE(  61)		super::__construct();
HXLINE(  63)		this->set_visible(false);
HXLINE(  64)		this->set_scaleX(this->_defaultScale);
HXLINE(  65)		this->set_scaleY(this->_defaultScale);
HXLINE(  66)		 ::openfl::display::Bitmap tmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,30,true,(int)2130706432),null(),null());
HXLINE(  67)		this->screenCenter();
HXLINE(  68)		this->addChild(tmp);
HXLINE(  70)		 ::openfl::text::TextField text =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
HXLINE(  71)		text->set_width(tmp->get_width());
HXLINE(  72)		text->set_height(tmp->get_height());
HXLINE(  73)		text->set_multiline(true);
HXLINE(  74)		text->set_wordWrap(true);
HXLINE(  75)		text->set_selectable(false);
HXLINE(  83)		 ::openfl::text::TextFormat dtf =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,10,16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  84)		dtf->align = 0;
HXLINE(  85)		text->set_defaultTextFormat(dtf);
HXLINE(  86)		this->addChild(text);
HXLINE(  87)		text->set_text(HX_("VOLUME",da,d5,d5,11));
HXLINE(  88)		text->set_y(( (Float)(16) ));
HXLINE(  90)		int bx = 10;
HXLINE(  91)		int by = 14;
HXLINE(  92)		this->_bars = ::Array_obj< ::Dynamic>::__new();
HXLINE(  94)		{
HXLINE(  94)			int _g = 0;
HXDLIN(  94)			while((_g < 10)){
HXLINE(  94)				_g = (_g + 1);
HXDLIN(  94)				int i = (_g - 1);
HXLINE(  96)				tmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,4,(i + 1),false,-1),null(),null());
HXLINE(  97)				tmp->set_x(( (Float)(bx) ));
HXLINE(  98)				tmp->set_y(( (Float)(by) ));
HXLINE(  99)				this->addChild(tmp);
HXLINE( 100)				this->_bars->push(tmp);
HXLINE( 101)				bx = (bx + 6);
HXLINE( 102)				by = (by - 1);
            			}
            		}
HXLINE( 105)		this->set_y(-(this->get_height()));
...
void FlxSoundTray_obj::update(Float MS){
            	HX_STACKFRAME(&_hx_pos_b1aa19ce59d84264_115_update)
HXDLIN( 115)		if ((this->_timer > 0)) {
HXLINE( 117)			 ::flixel::_hx_system::ui::FlxSoundTray _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 117)			_hx_tmp->_timer = (_hx_tmp->_timer - (MS / ( (Float)(1000) )));
            		}
            		else {
HXLINE( 119)			Float _hx_tmp = this->get_y();
HXDLIN( 119)			if ((_hx_tmp > -(this->get_height()))) {
HXLINE( 121)				{
HXLINE( 121)					 ::flixel::_hx_system::ui::FlxSoundTray _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 121)					Float _hx_tmp = _g->get_y();
HXDLIN( 121)					_g->set_y((_hx_tmp - (((MS / ( (Float)(1000) )) * ( (Float)(::flixel::FlxG_obj::height) )) * ( (Float)(2) ))));
            				}
HXLINE( 123)				Float _hx_tmp1 = this->get_y();
HXDLIN( 123)				if ((_hx_tmp1 <= -(this->get_height()))) {
HXLINE( 125)					this->set_visible(false);
HXLINE( 126)					this->active = false;
HXLINE( 129)					 ::flixel::util::FlxSaveStatus _g = ::flixel::FlxG_obj::save->status;
HXDLIN( 129)					bool _hx_tmp;
HXDLIN( 129)					if ((_g->_hx_getIndex() == 1)) {
HXLINE( 129)						::String _g1 = _g->_hx_getString(1);
HXDLIN( 129)						::String _g2 = _g->_hx_getString(0);
HXDLIN( 129)						_hx_tmp = true;
            					}
            					else {
HXLINE( 129)						_hx_tmp = false;
            					}
HXDLIN( 129)					if (_hx_tmp) {
HXLINE( 131)						::flixel::FlxG_obj::save->data->__SetField(HX_("mute",d9,6e,65,48),::flixel::FlxG_obj::sound->muted,::hx::paccDynamic);
...
void FlxSoundTray_obj::show(::hx::Null< bool >  __o_up){
            	...
            	HX_STACKFRAME(&_hx_pos_b1aa19ce59d84264_145_show)
HXLINE( 146)		if (!(this->silent)) {
HXLINE( 148)			::String id;
HXDLIN( 148)			if (up) {
HXLINE( 148)				id = this->volumeUpSound;
            			}
            			else {
HXLINE( 148)				id = this->volumeDownSound;
            			}
HXDLIN( 148)			::String extension = HX_("",00,00,00,00);
HXDLIN( 148)			extension = HX_(".ogg",e1,64,bc,1e);
HXDLIN( 148)			 ::openfl::media::Sound sound = ::openfl::utils::Assets_obj::getSound((id + extension),null());
HXLINE( 149)			if (::hx::IsNotNull( sound )) {
HXLINE( 150)				::flixel::FlxG_obj::sound->load(sound,null(),null(),null(),null(),null(),null(),null(),null())->play(null(),null(),null());
            			}
            		}
HXLINE( 153)		this->_timer = ( (Float)(1) );
HXLINE( 154)		this->set_y(( (Float)(0) ));
HXLINE( 155)		this->set_visible(true);
HXLINE( 156)		this->active = true;
HXLINE( 157)		int globalVolume = ::Math_obj::round((::flixel::FlxG_obj::sound->volume * ( (Float)(10) )));
HXLINE( 159)		if (::flixel::FlxG_obj::sound->muted) {
HXLINE( 161)			globalVolume = 0;
            		}
HXLINE( 164)		{
HXLINE( 164)			int _g = 0;
...
HXLINE( 166)				if ((i < globalVolume)) {
HXLINE( 168)					this->_bars->__get(i).StaticCast<  ::openfl::display::Bitmap >()->set_alpha(( (Float)(1) ));
            				}
            				else {
HXLINE( 172)					this->_bars->__get(i).StaticCast<  ::openfl::display::Bitmap >()->set_alpha(((Float)0.5));
            				}
            			}
            		}
            	}
...
void FlxSoundTray_obj::screenCenter(){
            	HX_STACKFRAME(&_hx_pos_b1aa19ce59d84264_178_screenCenter)
HXLINE( 179)		this->set_scaleX(this->_defaultScale);
HXLINE( 180)		this->set_scaleY(this->_defaultScale);
HXLINE( 182)		int _hx_tmp = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN( 182)		Float _hx_tmp1 = (((Float)0.5) * (( (Float)(_hx_tmp) ) - (( (Float)(this->_width) ) * this->_defaultScale)));
HXDLIN( 182)		this->set_x((_hx_tmp1 - ::flixel::FlxG_obj::game->get_x()));
            	}
