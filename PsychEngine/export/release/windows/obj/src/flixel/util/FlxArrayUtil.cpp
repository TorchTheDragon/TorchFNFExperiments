...
HX_LOCAL_STACK_FRAME(_hx_pos_80883519d7ae1644_177_contains,"flixel.util.FlxArrayUtil","contains",0x2d55b70a,"flixel.util.FlxArrayUtil.contains","flixel/util/FlxArrayUtil.hx",177,0xa0dc755b)
HX_LOCAL_STACK_FRAME(_hx_pos_80883519d7ae1644_186_safeContains,"flixel.util.FlxArrayUtil","safeContains",0xdcbed6f7,"flixel.util.FlxArrayUtil.safeContains","flixel/util/FlxArrayUtil.hx",186,0xa0dc755b)
namespace flixel{
namespace util{
...
HXLINE( 171)		array->push(element);
HXLINE( 172)		return array;
            	}
...
bool FlxArrayUtil_obj::contains(::cpp::VirtualArray array, ::Dynamic element){
            	HX_STACKFRAME(&_hx_pos_80883519d7ae1644_177_contains)
HXDLIN( 177)		return (array->indexOf(element,null()) != -1);
            	}
...
bool FlxArrayUtil_obj::safeContains(::cpp::VirtualArray array, ::Dynamic element){
            	HX_STACKFRAME(&_hx_pos_80883519d7ae1644_186_safeContains)
HXDLIN( 186)		if (::hx::IsNotNull( array )) {
HXDLIN( 186)			return (array->indexOf(element,null()) != -1);
            		}
            		else {
