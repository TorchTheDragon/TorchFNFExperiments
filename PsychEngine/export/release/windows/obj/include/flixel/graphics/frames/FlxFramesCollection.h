...
class HXCPP_CLASS_ATTRIBUTES FlxFramesCollection_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic addSpriteSheetFrame_dyn();
		 ...
		 ::flixel::graphics::frames::FlxFrame addAtlasFrame( ::flixel::math::FlxRect frame, ::flixel::math::FlxBasePoint sourceSize, ::flixel::math::FlxBasePoint offset,::String name,::hx::Null< int >  angle,::hx::Null< bool >  flipX,::hx::Null< bool >  flipY);
